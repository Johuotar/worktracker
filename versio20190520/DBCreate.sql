...
grant select, insert, update, delete on worktracker.* to 'worktrackAdmin'@'localhost';
...
,password(concat(substring(a.Etunimi,1,4),substring(a.Sukunimi,1,3))) as salasana
